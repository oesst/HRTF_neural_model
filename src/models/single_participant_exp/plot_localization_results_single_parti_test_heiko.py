...
import CIPIC.gammatone_read_cipic as file_reader
...
# psd_binaural = hp.filter_dataset((psd_all_i)/(psd_all_i + psd_all_c), normalization_type=normalization_type, sigma_smoothing=0, sigma_gauss_norm=0)
...
# plt.savefig('CIPIC/figures/localization_single_participant.pdf', dpi=300)
